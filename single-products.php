    ...
    <div class="container">
      ...
      <div class="flex flex-col xl:flex-row xl:-mx-10 mb-20">
        <div class="w-full xl:w-1/2 xl:px-10 mb-12 xl:mb-0">
          <!-- Хлебные крошки -->    
          <div class="breadcrumbs text-sm text-gray-800 mb-4" itemprop="breadcrumb" itemscope itemtype="https://schema.org/BreadcrumbList">
        ...
        <div class="w-full xl:w-1/2 xl:px-10">
          <div>
            <img src="<?php echo get_the_post_thumbnail_url(); ?>" alt="<?php the_title(); ?>" class="w-full h-[400px] object-cover relative rounded-lg" loading="lazy">
          </div>
        </div>
      </div>
      <!-- END TOP CONTENT -->
