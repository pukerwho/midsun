    ...
    <div class="flex flex-wrap flex-col xl:flex-row xl:items-center xl:-mx-10">
      <div class="w-full xl:w-1/2 xl:px-10">
        ...
        <div class="welcome-btn">
          ...
          <div class="relative text-xl mr-2"><?php _e("Замовити безкоштовний тест", "treba-wp"); ?></div>
          <div class="relative">
...
<div class="mb-32">
  <div class="container">
    <div class="flex xl:-mx-8">
      ...
      <div class="w-full xl:w-1/2 xl:px-8">
        <div class="font-title text-4xl leading-12 mb-6"><?php _e("Лише 1 з 4 брендів виділяється споживачами", "treba-wp"); ?>.</div>
    ...
    <div class="flex flex-col xl:flex-row xl:items-center xl:-mx-10">
      <div class="w-full xl:w-1/2 xl:px-10">
        <div class="relative overflow-hidden p-6 treba-animate fade-up">
          ...
          <!-- Content box -->
          <div class="relative">
            <div class="text-4xl font-title mb-10"><?php _e("Наука та", "treba-wp"); ?> <span class="text-primary"><?php _e("дослідження", "treba-wp"); ?></span></div>
            <div class="text-xl mb-8"><?php _e("ScentAir був заснований у відповідь на приголомшливі результати дослідження впливу аромату на емоції та поведінку людини", "treba-wp"); ?></div>
      ...
      <div class="w-full xl:w-1/2 xl:px-10">
        <div class="relative overflow-hidden p-6 treba-animate fade-up">
          ...
          <!-- Content box -->
          <div class="relative">
            <div class="text-4xl font-title mb-10"><span class="text-primary"><?php _e("Як працює", "treba-wp"); ?></span> <?php _e("аромамаркетінг", "treba-wp"); ?></div>
            <div class="text-xl mb-8"><?php _e("Створіть багатий клієнтський досвід за допомогою аромамаркетингу, який будує відносини між брендом та клієнтами та створює довготривалі враження.", "treba-wp"); ?></div>
            <div class="inline-flex relative bg-gradient-to-r from-main-gray to-main-dark border-2 border-main-gray rounded-xl px-6 py-4">
              <a href="#" class="absolute-link"></a>
...
<div class="mb-32">
  <div class="container">
    <div class="relative flex flex-col items-center">
      ...
      <h2 class="text-4xl leading-12 text-center font-title mb-6 treba-animate fade-up"><?php _e("Ароматизація бізнесу", "treba-wp"); ?></h2>
      <div class="flex items-center justify-center opacity-75 -mx-2 mb-6 treba-animate fade-up">
        <div class="bg-primary w-6 h-[1px] px-2"></div>
