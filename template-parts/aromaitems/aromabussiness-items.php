<div class="flex flex-wrap flex-col">
  ...
  <div class="aromabussiness-item w-full" data-number="2">
    <!-- Item Parent -->
    <div class="aromabussiness-item__parent w-full treba-animate mb-6">
      <div class="flex justify-between items-center bg-main-gray rounded-2xl cursor-pointer py-6 px-8">
        <div class="flex items-center">
          ...
          <div>
            <div class="text-2xl mb-2"><?php _e("Зони ароматизаціі", "treba-wp"); ?></div>
            <div class="opacity-75"><?php _e("Туалети, рецепція, ліфт, переговорна кімната, зона відпочинку", "treba-wp"); ?>...</div>
          </div>
        </div>
        <div class="flex items-center bg-main-dark rounded-2xl px-8 py-3">
          <div class="mr-2"><?php _e("Детальніше", "treba-wp"); ?></div>
  ...
  <div class="aromabussiness-item w-full" data-number="3">
    <!-- Item Parent -->
    <div class="aromabussiness-item__parent w-full treba-animate mb-6">
      <div class="flex justify-between items-center bg-main-gray rounded-2xl cursor-pointer py-6 px-8">
        <div class="flex items-center">
          ...
          <div>
            <div class="text-2xl mb-2"><?php _e("Ароматизація заходів", "treba-wp"); ?></div>
            <div class="opacity-75"><?php _e("Конференціі, виставки, презентації, свята", "treba-wp"); ?>...</div>
          </div>
        </div>
        <div class="flex items-center bg-main-dark rounded-2xl px-8 py-3">
          <div class="mr-2"><?php _e("Детальніше", "treba-wp"); ?></div>
  ...
  <div class="aromabussiness-item w-full" data-number="4">
    <!-- Item Parent -->
    <div class="aromabussiness-item__parent w-full treba-animate mb-6">
      <div class="flex justify-between items-center bg-main-gray rounded-2xl cursor-pointer py-6 px-8">
        <div class="flex items-center">
          ...
          <div>
            <div class="text-2xl mb-2"><?php _e("Аромабрендінг", "treba-wp"); ?></div>
            <div class="opacity-75"><?php _e("Інтеграція аромату в ваш бізнес", "treba-wp"); ?>...</div>
          </div>
        </div>
        <div class="flex items-center bg-main-dark rounded-2xl px-8 py-3">
          <div class="mr-2"><?php _e("Детальніше", "treba-wp"); ?></div>
